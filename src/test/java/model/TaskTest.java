...
class TaskTest {
    ...
    private LocalDateTime taskTime = LocalDateTime.of(2022, 01, 1, 00,
            00);
    private Duration taskDuration = Duration.ofHours(10);
    private Task task = new Task(1, TASK, "Task1", NEW, "Description task1",
            taskTime, taskDuration);
    private Task task2 = new Task(2, TASK, "Task2", NEW, "Description task2");
